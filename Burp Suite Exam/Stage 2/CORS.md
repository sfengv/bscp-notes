...
- `Access-Control-Allow-Credentials: true`
	- `Origin: hacker.com` > `Access-Control-Allow-Origin: hacker.com`
		- [[Burp Suite Exam/Stage 2/CORS#2.1. Lab CORS vulnerability with basic origin reflection ⭕️]]
	- `Origin: null` > `Access-Control-Allow-Origin: null`
		- [[CORS#2.2. Lab CORS vulnerability with trusted null origin ⭕️
	- `Origin: https://hacker.YOUR-LAB-ID.web-security-academy.net` > `Access-Control-Allow-Origin: https://hacker.YOUR-LAB-ID.web-security-academy.net`
...
![[Pasted image 20260222195053.png]]
