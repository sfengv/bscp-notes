...
1. Live chat > send something > refresh > notice that the "READY" command retrieves past chat messages. Or refreshing the page show the chat history even though we are not logged in. Send the "READY" message to Repeater > Send > also show the entire chat history.
	1. ![464](WebSockets-20260215112151198.png)
	2. ![458](WebSockets-20260215112205714.png)
	3. ![459](WebSockets-20260215112213508.png)
	4. ![457](WebSockets-20260215112451132.png)
	5. ![WebSockets-20260215112750623](WebSockets-20260215112750623.png)
2. Session cookie has `SameSite: None` means we can send the cookie to different domains. 
	1. ![WebSockets-20260215112600036](WebSockets-20260215112600036.png)
3. HTTP History > `GET /chat` doesn't have csrf token
	1. ![228](WebSockets-20260215112855828.png)
4. Paste the following payload > replace `your-websocket-url` and `your-collaborator-url` > deliver exploit to victim > check burp collaborator and see carlos's chat history with his password. Login to solve: `carlos:62kmcyd3l5q8z9sr326o`.
	1. ![WebSockets-20260215114320988](WebSockets-20260215114320988.png)
	2. ![470](WebSockets-20260215113744485.png)
...
```
![WebSockets-20260215114748975](WebSockets-20260215114748975.png)
![WebSockets-20260215114948614](WebSockets-20260215114948614.png)
...
1. Click live chat > enter a simple XSS payload > "Error: Attack detected: JavaScript". Refresh and got "This address is blacklisted".
	1. ![Extra Labs-20260127212339781](Extra%20Labs-20260127212339781.png)
	2. ![Extra Labs-20260127212458086](Extra%20Labs-20260127212458086.png)
```
...
1. Bypass IP restriction with `X-Forwarded-For`:
	...
	2. ![Extra Labs-20260127212929910](Extra%20Labs-20260127212929910.png)
	3. ![Extra Labs-20260127213241087](Extra%20Labs-20260127213241087.png)
2. #Useful Send the following obfuscated payload to solve the lab. 
	1. ![Extra Labs-20260127213335394](Extra%20Labs-20260127213335394.png)
```
<img src=1 oNeRrOr=alert`1`>
```
